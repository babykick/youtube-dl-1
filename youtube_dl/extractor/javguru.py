...
class JavguruIE(InfoExtractor):
    _VALID_URL = r'https?://(?:www\.)?jav\.guru/([^/]+/)*(?P<id>[^/\?#]+)'
    _TESTS = [{
    ...
    def _real_extract(self, url):
        ...
        print(webpage)
        # get_video request
        'https://streamtape.com/get_video?id=jq43YLR9Gmiz1yy&expires=1609986528&ip=GxIsDHSnDS9X&token=tUvK86ntRNiv&stream=1'
        # print('jq43YLR9Gmiz1yy' in webpage)
        exit()
